    ...
    <div style={{minHeight:'100vh',background:'linear-gradient(135deg,#1a1a2e,#0f3460)',fontFamily:'Segoe UI'}}>
      ...
      <div style={{padding:'60px 40px',textAlign:'center'}}>
        ...
        <div style={{display:'grid',gridTemplateColumns:'repeat(3,1fr)',gap:'24px',maxWidth:'800px',margin:'0 auto'}}>
          ...
          <div style={{background:'rgba(255,255,255,0.05)',border:'1px solid rgba(255,255,255,0.1)',borderRadius:'16px',padding:'32px',color:'#fff',fontSize:'32px'}}>💳<h3>Pagos</h3><p style={{fontSize:'14px',color:'rgba(255,255,255,0.5)'}}>Proximamente</p></div>
          ...
          {user.rol === 'propietario' && (
            <div onClick={() => navigate('/panel-propietario')} style={{background:'linear-gradient(135deg,rgba(255,200,0,0.1),rgba(255,150,0,0.1))',border:'1px solid rgba(255,200,0,0.3)',borderRadius:'16px',padding:'32px',color:'#fff',fontSize:'32px',cursor:'pointer'}}>👑<h3>Panel Propietario</h3><p style={{fontSize:'14px',color:'rgba(255,255,255,0.5)'}}>Gestion completa</p></div>
          )}
        </div>
      </div>
    </div>
