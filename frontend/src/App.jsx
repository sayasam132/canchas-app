  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/facturas" element={token && esPropietario ? <Facturas /> : <Navigate to="/dashboard" />} />
        <Route path="/estadisticas" element={token && esPropietario ? <Estadisticas /> : <Navigate to="/dashboard" />} />
