...
const { getCanchas, getCancha, getHorasOcupadas, crearCancha, editarCancha, eliminarCancha, getTodasCanchas } = require('../controllers/canchas.controller')
const authMiddleware = require('../middleware/auth.middleware')

router.get('/todas', getTodasCanchas)
